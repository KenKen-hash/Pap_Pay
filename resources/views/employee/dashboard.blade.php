                ...
                <div class="container-fluid px-3 px-lg-4">
                    ...
                    <form class="d-none d-md-flex ms-3 flex-grow-1" action="{{ route('search') }}" method="GET">
                        ...
                        <input class="form-control search-input" type="search" name="search"
                            placeholder="Search attendance, leave, payroll..." required>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end notification-menu">
                                ...
                                @forelse($notifications as $notification)
                                    <a class="dropdown-item" href="{{ url($notification->url) }}">
                ...
                <div class="container-fluid px-3 px-lg-4 py-4">
                    ...
                    <div class="welcome-card">
                        ...
                        <div class="d-none d-md-block text-end">
                            ...
                            <p class="mb-0 mt-2 text-muted small">Employee ID:
                                {{ $employee->employee_id ?? 'EMP-0000' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="hero-banner">
                        ...
                        <div class="hero-overlay">
                            ...
                            <p>Your centralized portal for managing attendance, leave requests, payroll information, and
                                official business records. Access all your employment essentials in one secure platform.
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="salary-panel">
                                ...
                                <div class="salary-breakdown">
                                    ...
                                    <div class="salary-item deduction">
                                        ...
                                        <span>-₱{{ number_format(
                                            ($latestSalary->sss ?? 0) + ($latestSalary->philhealth ?? 0) + ($latestSalary->pagibig ?? 0),
                                            2,
                                        ) }}</span>
                                    </div>
...
@else text-bg-danger @endif">{{ $record->status }}</span>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                    ...
                                    @empty
                                        <div class="activity-item">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-muted small mb-0">June payroll will be released on the
                                                    25th.</p>
                                            </div>
                                        </div>
                                        <div class="activity-item">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-muted small mb-0">Monthly faculty meeting scheduled for
                                                    June 28.</p>
                                            </div>
                                        </div>
                                        <div class="activity-item">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-muted small mb-0">Please file leaves at least 3 days in
                                                    advance.</p>
                                            </div>
                                        </div>
                                        <div class="activity-item">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-muted small mb-0">Portal maintenance on Sunday, 2-4 AM.
                                                </p>
                                            </div>
                                        </div>
                                    @endforelse
