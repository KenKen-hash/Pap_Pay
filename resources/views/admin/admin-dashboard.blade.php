...
<div class="page-heading">
  <div>
    ...
    <p class="text-muted">Monitor employees, attendance, payroll, and HR operations in real time.</p>
  </div>
</div>
...
<div class="metric-meta">
    <span class="text-success">Registered Employees</span>
</div>
    </div>
  </div>
...
<section class="panel mt-4">
  <div class="panel-header">
    ...
    <p class="text-muted">Monthly attendance performance</p>
  </div>

  <div class="chart-bars">
    <div class="chart-column bar-80"><span></span><small>Mon</small></div>
    <div class="chart-column bar-75"><span></span><small>Tue</small></div>
    <div class="chart-column bar-90"><span></span><small>Wed</small></div>
    <div class="chart-column bar-70"><span></span><small>Thu</small></div>
    <div class="chart-column bar-85"><span></span><small>Fri</small></div>
  </div>
</section>
<section class="panel mt-4">
  <div class="panel-header">
