...
<input type="text" name="pay_period" placeholder="e.g. June 1-15" class="form-control mt-2">

<input type="number" name="basic_pay" placeholder="Basic Pay" class="form-control mt-2">

<input type="number" name="net_pay" placeholder="Net Pay" class="form-control mt-2">

<input type="number" name="sss" placeholder="SSS" class="form-control mt-2">

<input type="number" name="philhealth" placeholder="Philhealth" class="form-control mt-2">

<input type="number" name="pagibig" placeholder="Pagibig" class="form-control mt-2">

<input type="number" name="tax" placeholder="Tax" class="form-control mt-2">
