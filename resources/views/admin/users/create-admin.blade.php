...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="glass">
            ...
            <p class="text-light opacity-75">
                ...
                Select the administrator category and generate temporary login credentials.

            </p>

            <form action="{{ route('users.admin.setup') }}" method="POST">
    ...
    <label class="department-card" for="receivable">

        <i class="bi bi-cash-stack"></i>

        <h5>Accounts Receivable</h5>

       <p>Manages incoming payments and customer collections.</p>
