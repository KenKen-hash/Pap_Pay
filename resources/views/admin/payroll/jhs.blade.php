...
<head>
    ...
    <title>JHS Salary Configuration | PAP PAY</title>
    ...
    <div class="wrapper">
        ...
        <div class="glass">
            ...
            <div class="d-flex justify-content-between align-items-start mb-4">
                ...
                <div>
                    ...
                    <h1 class="page-title">
                        ...
                        JHS Salary Configuration

                    </h1>

                    <p class="page-subtitle">

                        Configure the default payroll settings for all JHS employees.
            ...
            <div class="section">
                ...
                <form>
                    <input type="hidden" id="department" value="JHS">
