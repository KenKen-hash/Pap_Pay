...
<div class="container-fluid px-3 px-lg-4 py-4">
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center mb-4">
        ...
        <div class="d-flex gap-2 mt-3 mt-lg-0">
            ...
            <a href="{{ route('attendance.export.csv', request()->all()) }}"
    ...
    <form class="row g-2 mb-3">
        ...
        <div class="col-md-2">
            <a href="{{ route('attendance_list') }}" class="btn btn-outline-secondary w-100">
                Reset
            </a>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small class="text-muted">{{ $attendance->user->department }}</small>
                            </td>
